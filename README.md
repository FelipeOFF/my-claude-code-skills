...
| [`sleepwell`](./sleepwell) | Native Claude Code plugin for autonomous overnight loops. Combines gnhf discipline (isolated branch, atomic commit per iteration, automatic rollback on fail) with overnight adaptation (voice matching, 4 modes, meta-learning between runs). Runs **inside** the CC session — keeps prompt cache warm and MCPs alive. Inspired by [yail259/overnight](https://github.com/yail259/overnight), [thebasedcapital/nightcrawler](https://github.com/thebasedcapital/nightcrawler), and [kunchenguid/gnhf](https://github.com/kunchenguid/gnhf). | [./sleepwell](./sleepwell) |
